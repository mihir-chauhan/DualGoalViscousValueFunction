...
case $ENV_GROUP in
  ...
  # === POINTMAZE (Split into Stitch/Nav) ===
  "pm_stitch")
  ...
  # === ANTMAZE (Split into Nav/Stitch/Explore) ===
  "am_nav")
  ...
  "am_stitch")
    ...
    ;;
  "am_explore")
    # I added Scene (2 runs) here because this group was only 3 runs. Total = 5.
  ...
  # === HUMANOIDMAZE (Split into Nav/Stitch) ===
  "hm_nav")
