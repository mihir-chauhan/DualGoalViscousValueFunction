...
class GCValue(nn.Module):
    ...
    def value_head(self, input_embeds, actions=None):
        """Return the value/critic function.

        Args:
            input_embeds: Encoded observations and goals.
    ...
    def __call__(self, observations, goals=None, actions=None, return_embedding = False, is_embedding = False):
        """Return the value/critic function.
        ...
        if self.gc_encoder is not None and return_embedding:
            return v, inputs
        return v
